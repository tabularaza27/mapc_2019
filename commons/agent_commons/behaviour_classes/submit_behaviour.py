...
class SubmitBehaviour(BehaviourBase):

    def \
            __init__(self, name, agent_name, rhbp_agent, **kwargs):
        """Attach to Block
        ...
        """
        super(SubmitBehaviour, self).__init__(name=name, requires_execution_steps=True,
